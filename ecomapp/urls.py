...
urlpatterns = [
    ...
    # Client side pages
    path("download_report_revenue_excel/<slug:monthyear>", Reports.download_file_excel, name="download_excel"),
...
#     # Admin Side pages
    ...
    path("admin-dashboard/", AdminDashboardView.signed_public_dashboard, name="admindashboard"),
